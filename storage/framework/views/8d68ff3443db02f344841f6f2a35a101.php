    ...
    <div class="bg-green-50 border-l-4 border-green-500 rounded-lg p-6">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-bold"><?php echo e($totalStok); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-purple-50 border-l-4 border-purple-500 rounded-lg p-6">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-bold">Rp <?php echo e(number_format($totalNilai, 0, ',', '.')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('items.index')); ?>" class="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-md flex items-center">
        ...
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">Rp <?php echo e(number_format($item->harga * $item->jumlah, 0, ',', '.')); ?></td>
                </tr>
